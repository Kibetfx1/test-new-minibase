...
function nlCtx(botName,nlJid,botImg,repo){return{forwardingScore:999,isForwarded:true,forwardedNewsletterMessageInfo:{newsletterJid:nlJid||'120363421104812135@newsletter',newsletterName:botName||'🔥 TEDDY-XMD 🔥',serverMessageId:-1},externalAdReply:{title:botName||'🔥 TEDDY-XMD 🔥',body:'Owner: Abdul Rehman Rajpoot',thumbnailUrl:botImg||'https://files.catbox.moe/13nyhx.jpg',sourceUrl:repo||'https://github.com/Teddytech1/TEDDY-XMD',mediaType:1,renderLargerThumbnail:false}};}
